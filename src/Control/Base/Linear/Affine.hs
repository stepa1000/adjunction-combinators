...
coadjqdA :: (Comonad w, Num a, Affine t, Foldable (Diff t)) => W.AdjointT (Env (t a)) (Reader (t a)) w (t a) -> a
coadjqdA = coadjBiparam qdA

coadjDistanceA :: (Comonad w, Num a, Affine t, Floating a, Foldable (Diff t)) => W.AdjointT (Env (t a)) (Reader (t a)) w (t a) -> a
